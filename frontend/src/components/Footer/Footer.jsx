      ...
      <Container>
        <Row>
          ...
          <ListGroup className='footer__quick-links'>
                ...
                <ListGroupItem  className="ps-0 border-0 d-flex align-items-center gap-3">
                 ...
                 <ListGroupItem  className="ps-0 border-0 d-flex align-items-center gap-3">
                  ...
                  <p className='mb-0'>musthashaik@gmail.com</p>
                ...
                <ListGroupItem  className="ps-0 border-0 d-flex align-items-center gap-3">
                  ...
                  <p className='mb-0'>+91 7799819037</p>
          ...
          <Col lg='12' className='text-center pt-5'>
            <p className='copyright'> Copyright 2025 , design and developed by Musthafa Shaik . All Rights reserved </p>
          </Col>
        </Row>
      </Container>
